...
def render():
    ...
    shell = shell.replace('# Public source snapshot: no default prebuilt channel; use an explicitly approved package.', '# Default downloads: verified GitHub Releases and pinned GitHub LFS assets.')
