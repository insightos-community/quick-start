...
# Public source snapshot: no default prebuilt channel; use an explicitly approved package.
...
p.add_argument('--base-url', default=os.environ.get('SEMANTIC_DOWNLOAD_BASE', ''))
