...
The rc.3 installer fixes Robot instance supervisor exits caused by x86_64 metadata in the seven Python Ability packages. Native CI now starts both project robots and checks AbilityFramework, all seven abilities and Pilot readiness. Stop your old instance and install this release into a new directory; existing databases are not migrated automatically.
