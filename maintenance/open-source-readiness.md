...
- R1 Pro maintenance models and their catalog entry are restored via LFS following the project owner's 2026-09-10 publication instruction; third-party attribution is preserved.
...
simulation needs the pinned LFS models, source builds and runtime initialization. Public
...
Keep credentials, unapproved locally imported models, caches and build products outside commits.
